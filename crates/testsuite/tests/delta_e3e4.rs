...
//!
//! Fixture derivation discipline: S1/S2 states derive from the frozen §4.4 worked
//! splice requests applied to the committed S0 bytes — E3: `"ship by
...
//! with a printed §7.1 value this suite fails; bytes are never hand-tuned.
