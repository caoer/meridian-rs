...
Run 2026-07-18 15:35 UTC · `zmax` (aarch64 macos, Apple M4 Max, 16 cores) · git `c099822` · rustc 1.96.0 (ac68faa20 2026-05-25) · report schema v1
...
| `transport.codec.ndjson_roundtrip_p99` | us | — | — | 19.055 | MEASURED | LIVE day 1 (NdjsonCodec is implemented); no baseline yet — first fleet run establishes it |
...
|---|---|---|---|---|---|---|---|---|
| `transport.codec.ndjson_roundtrip_p99` | 19.055 | us | 20000 | 8.4 | 15.3 | 19.1 | 26.4 | 41.8 |
