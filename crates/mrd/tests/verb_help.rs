...
/// The classification itself, pinned: sixteen verbs change files or the
...
/// `rm` is the guarded file death (§ A.3 remove door); `arm` writes the
/// attested armed-rules artifact and, on the first arm, the once-armed marker;
